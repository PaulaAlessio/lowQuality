...
getQualAbundancies <- function(data){
   ...
   QualAbund <- matrix(0,nrow = rows, ncol= quals, dimnames = list(NULL,data$qual_tags))
   i <- 1
...
simulateQ <- function(){
   ...
   means <- c(25,25,25,25,31,32,32,32,32,35,35,36,35,36,37,37,37,37,37,37,37,31,29,28,27)
   for (i in 1:25){
